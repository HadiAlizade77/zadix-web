      ...
      <main>
        <div className="min-h-screen pt-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h1 className="text-4xl font-bold text-cream mb-8">Data Processing Addendum (DPA)</h1>
            <div className="prose prose-lg max-w-none">
              <p className="text-muted mb-6">Last updated: January 2024</p>
              
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">Summary</h2>
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">1. Definitions</h2>
              <p className="text-muted mb-4">
                This Data Processing Addendum (&quot;DPA&quot;) forms part of the service agreement between 
                Zadix (&quot;Processor&quot;) and the Client (&quot;Controller&quot;).
              </p>
              
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">2. Processing of Personal Data</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">3. Security Measures</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">4. Data Subject Rights</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">5. Data Retention</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">6. Sub-processors</h2>
              <p className="text-muted mb-4">
                Zadix may engage sub-processors for hosting, analytics, and email services. 
                A current list of sub-processors is available upon request.
              </p>
              
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">7. International Transfers</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">8. Contact</h2>
              <p className="text-muted mb-4">
                For DPA-related inquiries, contact our Data Protection Officer at{' '}
                <a href="mailto:dpo@zadix.ai" className="text-amber hover:underline">
                  dpo@zadix.ai
                </a>
              </p>
              
              <div className="bg-surface-2 rounded-lg p-6 mt-8">
                <h3 className="text-lg font-bold text-cream mb-3">Request Signed DPA</h3>
                <p className="text-muted mb-4">
                ...
                <a 
                  ...
                  className="inline-flex items-center text-amber hover:text-amber-dim font-medium"
                >
                  Request signed DPA
