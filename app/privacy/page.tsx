      ...
      <main>
        <div className="min-h-screen pt-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h1 className="text-4xl font-bold text-cream mb-8">Privacy Policy (GDPR Compliance)</h1>
            <div className="prose prose-lg max-w-none">
              <p className="text-muted mb-6">Last updated: January 2025</p>
              
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">1. Introduction</h2>
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">2. Information We Collect</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">3. How We Use Your Information</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">4. Information Sharing</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">5. International Transfers</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">6. Data Retention</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">7. Your Rights</h2>
              <p className="text-muted mb-4">
                ...
                <a href="mailto:privacy@zadix.ai" className="text-amber hover:underline">
                  privacy@zadix.ai
                </a>.
                You also have the right to lodge a complaint with the UK Information Commissioner’s Office (ICO) at <a href="https://ico.org.uk" target="_blank" className="text-amber hover:underline">ico.org.uk</a>.
              </p>

              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">8. Data Security</h2>
              <p className="text-muted mb-4">
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">9. Contact Us</h2>
              <p className="text-muted mb-4">
                Zadix AI Ltd<br />
              ...
              <h2 className="text-2xl font-bold text-cream mt-8 mb-4">10. Changes to This Policy</h2>
              <p className="text-muted mb-4">
